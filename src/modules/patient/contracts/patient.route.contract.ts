...
export const patientRouteContract: ModuleRouteContract = {
  ...
  routes: [
    ...
    { method: 'POST', path: '/triage-evaluations/run', auth: 'roles', roles: ['patient'], validations: { body: 'RunTriageEvaluationSchema' } },
    { method: 'GET', path: '/mes-rendez-vous', auth: 'roles', roles: ['patient'] },
    { method: 'GET', path: '/mes-consultations', auth: 'roles', roles: ['patient'] },
    { method: 'GET', path: '/dossier-medical', auth: 'roles', roles: ['patient'] },
